...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  display = false;
  displayMaster = false;
  displayGameSettings = false;
  displayReport = false;
  displaySuperStockistReport = false;
  displaySuperStockistMaster = false;
  displayStockistMaster = false;
  ...
  toggleISuperStockistMaster(){
    this.displaySuperStockistMaster = !this.displaySuperStockistMaster;
  }

  toggleSuperStockistReport(){
    this.displaySuperStockistReport = !this.displaySuperStockistReport;

  }

  toggleStockistMaster(){
    this.displayStockistMaster = !this.displayStockistMaster;
