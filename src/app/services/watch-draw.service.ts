...
export class WatchDrawService {
  ...
  constructor(private http: HttpClient, private gameResultService: GameResultService, private playGameService: PlayGameService
              ...
              , private commonService: CommonService, private  resultService: ResultService) {
      ...
      this.http.get(this.BASE_API_URL + '/dev/nextDrawId').subscribe((response: NextDrawId) => {
        if (Object.entries(this.nextDrawId).length === 0){
          ...
          if (userData == null){
            ...
            this.resultService.getTodayResultByGameId(1);
            // this.resultService.getTodayResultByGameId(2);
            // this.resultService.getTodayResultByGameId(3);
            // this.resultService.getTodayResultByGameId(4);
            // this.resultService.getTodayResultByGameId(5);
          }else{
            this.resultService.getTodayResultByGameId(1);
            // this.resultService.getTodayResultByGameId(2);
            // this.resultService.getTodayResultByGameId(3);
